...
public class GertecPrinter implements Printer.Listener {
    ...
    public void printText(MethodCall call, Result result) throws PrinterException {
        // Parse arguments.
    ...
    public void printImage(MethodCall call, Result result) throws PrinterException {
        // Parse arguments.
    ...
    public void printHtml(MethodCall call, Result result) throws PrinterException {
        // Parse arguments.
        ...
        if (printConfig != null && hasAssetsLoading != null) {
            requestId = printer.printHtml(this.context, printConfig, htmlCode, hasAssetsLoading);
        } else {
            requestId = printer.printHtml(this.context, htmlCode);
        }

        result.success(requestId);
    }

    public void printTable(MethodCall call, Result result) throws PrinterException {
        // Parse arguments.
    ...
    public void scrollPaper(MethodCall call, Result result) {
        // Parse arguments.
    ...
    public void printBarcode(MethodCall call, Result result) throws PrinterException {
        // Parse arguments.
    ...
    public void getStatus(MethodCall call, Result result) throws PrinterException {
        // Call corresponding method based on arguments.
    ...
    public void cutPaper(MethodCall call, Result result) {
        // Parse arguments.
